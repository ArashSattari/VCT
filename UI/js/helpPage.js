...
function updateHelpPage() {
    switch (helpStepTracker) {
        ...
        case 1:
            ...
            $(".help .body #description").html("<b style= 'font-size:15px'>To update a sign follow the bellow steps:</b>" +
                "<br /><br />" +
                "<span style = 'color: #666666'>1. </span> Select one of the shops you possess, from the combo list.<br /><br/>" +
        ...
        case 2:
            ...
            $(".help .body #description").html("<b style= 'font-size:15px'> To post a comment or give a feedback about the others' signs " +
                "follow the bellow steps:</b>" +
                "<br /><br />" +
